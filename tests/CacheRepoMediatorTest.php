...
class MergeHelper_CachedRepoMediatorTest extends PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$this->oRepoMediator = new MergeHelper_CachedRepoMediator($this->oRepoCache);
	}

	public function test_construct() {
		$oRepoMediator = new MergeHelper_CachedRepoMediator($this->oRepoCache);
		$this->assertTrue(is_object($oRepoMediator));
	}

	public function test_getRevisionsInRange() {
		$oRepoMediator = new MergeHelper_CachedRepoMediator($this->oRepo);
	...
	public function test_getRevisionsForString() {
		...
		$aoRevisions = $this->oRepoMediator->aoGetRevisionsForString('World');
	...
	public function test_getCommonSourcePathForFullPathNoSourcePaths() {
		...
		$oRepoMediator = new MergeHelper_CachedRepoMediator($oRepo);
